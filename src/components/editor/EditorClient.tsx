...
export default function EditorClient({
  ...
  return (
    <div className="flex flex-col h-screen bg-white overflow-hidden">
      {/* ──────────────── Top Bar ──────────────── */}
      <header className="flex items-center justify-between px-4 py-3 bg-white border-b border-gray-200 flex-shrink-0 z-30">
        {/* Left: back + title */}
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className="w-70 flex-shrink-0 bg-gray-50 border-l border-gray-200 flex flex-col overflow-hidden">
