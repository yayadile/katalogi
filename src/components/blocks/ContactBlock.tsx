...
function ContactInfoCards({
  email, waLink, whatsapp, address, primaryColor
}: {
  email?: string
  waLink: string | null
  whatsapp?: string
  ...
  return (
    <div className="bg-slate-50 rounded-3xl p-8 space-y-5 w-full">
      {email && (
        <a
          href={`mailto:${email}`}
        ...
        >
          ...
          >
            <svg className="w-6 h-6 text-[#25D366]" fill="currentColor" viewBox="0 0 24 24">
              ...
              <path d="M11.999 0C5.373 0 0 5.373 0 12c0 2.127.558 4.12 1.532 5.847L.056 23.964l6.283-1.645A11.937 11.937 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 11.999 0zm.001 21.818a9.812 9.812 0 01-5.031-1.384l-.359-.214-3.731.977.997-3.64-.235-.374A9.818 9.818 0 012.182 12C2.182 6.575 6.575 2.182 12 2.182S17.425 2.182 21.818 12 17.425 21.818 12 21.818z"/>
            </svg>
          </div>
          <div className="text-left">
