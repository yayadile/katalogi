  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="relative mb-8 group">
        ...
        <div className="w-24 h-24 bg-white border border-gray-100 shadow-xl shadow-indigo-600/5 rounded-[2rem] flex items-center justify-center relative z-10 -rotate-3 group-hover:-rotate-6 transition-transform duration-500">
      ...
      <h1 className="text-3xl font-black text-gray-900 mb-4 tracking-tight">Tagihan & Langganan</h1>
      <p className="text-gray-500 text-lg max-w-md font-medium leading-relaxed">
        Fitur ini sedang dalam tahap pengembangan. Segera Anda bisa mengelola dan meningkatkan paket langganan Anda di sini.
      </p>
    </div>
  )
}
