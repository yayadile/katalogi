            ...
            {showLinkInput && (
              ...
              >
                <input
                  ...
                  placeholder="https://..."
                  className="bg-slate-700 text-white text-xs rounded px-2 py-1 w-40 outline-none focus:ring-1 focus:ring-indigo-600"
                />
                <button
                  type="button"
                  onMouseDown={(e) => { e.preventDefault(); setLink() }}
                  className="text-xs bg-indigo-600 text-white px-2 py-1 rounded hover:bg-indigo-600 cursor-pointer"
                >
                  OK
                </button>
              </div>
