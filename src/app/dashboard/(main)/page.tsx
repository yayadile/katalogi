    ...
    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-0">
      ...
      <div className="pt-16 pb-12 flex flex-col xl:flex-row xl:items-end justify-between gap-10 border-b border-gray-200/50">
        <div className="space-y-6 flex-1">
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black text-gray-950 tracking-tighter uppercase leading-[1.1]">
            Selamat datang,<br />
            <span className="text-indigo-600 relative inline-block pb-2">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-6 xl:justify-end">
          <div className="flex items-center gap-4 bg-white border border-gray-200 p-4 rounded-3xl shadow-sm">
             ...
             <div className="flex flex-col px-4">
               <span className="text-2xl font-black text-indigo-600">{activeProjects}</span>
          ...
          <Link
            ...
            className="shrink-0 inline-flex items-center justify-center gap-2 px-8 py-5 bg-linear-to-br from-indigo-500 to-indigo-900 hover:from-indigo-600 hover:to-indigo-950 text-white rounded-3xl font-bold text-lg transition-all hover:scale-[1.02] active:scale-[0.98] shadow-xl shadow-indigo-600/25 group"
          >
      ...
      <div className="space-y-10">
        <ScrollReveal delay={100} className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
             ...
             <span className="text-sm font-black text-indigo-600 bg-indigo-50 border border-indigo-100 px-4 py-1.5 rounded-full shadow-sm">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 pb-20">
          ...
          <Link
            href="/dashboard/create"
            className="group relative bg-gray-50 border-2 border-dashed border-gray-200 hover:border-indigo-500 hover:bg-indigo-50/30 rounded-[2.5rem] p-8 transition-all duration-500 hover:shadow-2xl hover:shadow-indigo-600/5 flex flex-col items-center justify-center h-full min-h-[340px] text-center overflow-hidden"
          >
            <div className="absolute inset-0 bg-linear-to-br from-indigo-600/2 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
          ...
          {websites.map((website, index) => (
            ...
            <div
              className="group relative bg-white border border-gray-200 hover:border-indigo-500/50 rounded-[2.5rem] p-8 flex flex-col min-h-[340px] transition-all duration-500 hover:-translate-y-2 hover:shadow-lg focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2 overflow-hidden"
            >
              ...
              <div className="relative z-10 flex-1">
                <h3 className="text-gray-900 font-black text-2xl mb-3 truncate group-hover:text-indigo-600 transition-colors tracking-tight">
                  {website.title}
                </h3>
              ...
              <div className="relative z-10 flex items-center gap-3">
                <Link
                  ...
                  className="flex-1 text-center text-sm font-bold py-4 px-6 bg-linear-to-br from-indigo-500 to-indigo-900 text-white hover:bg-indigo-700 rounded-2xl transition-all shadow-lg shadow-indigo-600/10 active:scale-95"
                >
                  Edit Desain
                </Link>
                {website.isPublished && (
                  <a
                    ...
                    className="p-4 bg-white border border-gray-200 text-gray-400 hover:text-indigo-600 hover:border-indigo-300 rounded-2xl transition-all active:scale-95"
                    title="Lihat Live"
                  >
