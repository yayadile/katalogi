  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="relative mb-8 group">
        ...
        <div className="w-24 h-24 bg-white border border-gray-100 shadow-xl shadow-indigo-600/5 rounded-4xl flex items-center justify-center relative z-10 -rotate-3 group-hover:-rotate-12 transition-transform duration-500">
